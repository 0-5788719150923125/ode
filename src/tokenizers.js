...
class CharacterTokenizer extends TokenizerBase {
    constructor(config) {
        ...
        this.corpus =
            config?.corpus ||
            `\n !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[]^_\`abcdefghijklmnopqrstuvwxyz{|}~¡£§©¬®°±²³µ¶·¹º»¼½ÀÁÄÅÇÉÎÓÔÖ×ØÜßàáâãäåæçèéêëíîïðñóôõö÷øúüĀāăćČčđēěğħīİıłńōőśşšūůŷźŽžȧȲȳɛʌʻʼˆ˚̸̂̄̅ΑΒΓΔΘΛΠΣΦΨΩέήίαβγδεζηθικλμνοπρςστφχψωόϵкѰḗṓợἴὁ​‐–—‘’“”†•․… ′″⁴⁻₀₁₂₃₄ₖₙ€ℓℕℚℝ™ℤ⅓←↑→↓↔↦⇌⇒⇔⇠⇥∀∂∃∅∆∇∈∉∏∑−∗∘∙√∞∠∧∨∩∪∫∼≅≈≠≡≤≥≫⊂⊆⊕⊙⋅⌈⌉⌘─│└├■□▶◆○●◦♢♥♦✓❤⟨⟩⨯⩽ⱼⲜ。・世前务发后告周在将我报新更末本界的给请财送道\ud835\ud835𝝅\udf48\udf73`
